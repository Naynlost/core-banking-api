...
internal sealed class ListAccountsQueryHandler(
    ...
    IBalanceProjection balances) : IQueryHandler<ListAccountsQuery, IReadOnlyList<AccountResponse>>
{
        ...
        ListAccountsQuery query, CancellationToken cancellationToken)
    {
        ...
        {
            responses.Add(await AccountResponses.FromAsync(account, balances, cancellationToken));
        }
